...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <header>
    <nav class="px-56 py-4 bg-black border-black-200 lg:px-6 " style="position: fixed;  overflow: hidden; top: 0;width: 100%;">
        <div class="flex flex-wrap items-center justify-between mx-auto max-w-screen-2xl">
            <a href="https://iam.miescor.ph/miesapps" class="flex items-center">
                <img src="https://iam.miescor.ph/miesapps/mies.png" class="h-8 mr-4 sm:h-12" alt="Flowbite Logo" />
                <!-- <span class="self-center text-xl font-semibold whitespace-nowrap" style="color: white"><span style="color: #f85815;font-size: 25px;">////</span>MIESCOR</span> -->
            </a>
            <div class="flex items-center lg:order-2">
                <a href="/miesapps/admin" class="text-gray-800 bg-orange-50 hover:bg-gray-800 focus:ring-4 focus:ring-orange-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2  " ><span style="color: #f85815;">Log in</span></a>
                <!-- <a href="#" class="text-white bg-gray-600 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 ">Get started</a> -->
            ...
            <div class="items-center justify-between hidden w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                <ul class="flex flex-col mt-5 font-medium lg:flex-row lg:space-x-16 lg:mt-0">
                    <li>
                        <a href="#" class="block py-2 pl-3 pr-4 text-white rounded bg-primary-700 lg:bg-transparent lg:text-primary-700 lg:p-0 " aria-current="page"><span style="color: #f85815;">Home</span></a>
                    </li>
                    <li>
                        <a href="#" class="block py-2 pl-3 pr-4 text-white border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 ">News & Updates</a>
                    </li>
                    <li>
                        <a href="#" class="block py-2 pl-3 pr-4 text-white border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 ">Company</a>
                    </li>
                    <li>
                        <a href="#" class="block py-2 pl-3 pr-4 text-white border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 ">Marketplace</a>
                    </li>
                    <li>
                        <a href="#" class="block py-2 pl-3 pr-4 text-white border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 ">Features</a>
                    </li>
                    <li>
                        <a href="#" class="block py-2 pl-3 pr-4 text-white border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 ">Team</a>
                    </li>
                    <li>
                        <a href="#" class="block py-2 pl-3 pr-4 text-white border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 ">Contact</a>
                    </li>
                </ul>
            </div>
        </div>
...
<body>
    <div>
        ...
        <!-- first section -->
        <section class="bg-gray-100"style="padding-top: 120px;padding-bottom: 100px;background-image: url('https://iam.miescor.ph/integrity50.png');background-repeat: no-repeat;background-size: cover;">
            <div class="grid px-4 py-8 mx-auto max-w-screen-2xl lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                <div class="mr-auto place-self-center lg:col-span-7" style="margin-top: 30px;">
                    <p class="max-w-2xl font-light md:text-xl lg:text-2xl" style="color: gold;font-weight: 400;">Golden Legacy</p>
                    <h1 class="max-w-2xl mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-300 md:text-5xl xl:text-6xl">I AM <span style="color: #f85815;">MIESCOR</span>: 50 Year Of The Values That Power The Nation</h1>
                    <p class="max-w-2xl mb-6 font-light text-gray-400 lg:mb-8 md:text-lg lg:text-xl ">50th Anniversary Coffee Table Book.</p>
                    <a href="https://iam.miescor.ph/MIESCOR%20BOOK%20FA.pdf" class="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 ">
                        Get started
                        <svg class="w-5 h-5 ml-2 -mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                    </a>
                    <a href="https://iam.miescor.ph/MIESCOR%20BOOK%20FA.pdf" class="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-orange-200 border border-gray-300 rounded-lg hover:bg-black-100 focus:ring-1 focus:ring-orange-900 ">
                        Learn More
                    </a>
                </div>
        ...
        <section class="bg-gray-200 ">
            <div class="max-w-screen-xl px-4 py-8 mx-auto lg:py-16 lg:px-6">
                <div class="max-w-screen-md mx-auto mb-8 text-center lg:mb-12">
                    <h2 class="mb-4 text-4xl font-extrabold tracking-tight text-gray-900 ">MIESCOR 50 Years</h2>
                    <p class="mb-5 font-light text-gray-500 sm:text-xl ">I AM MIESCOR 50 Years Of The Values That Power The Nation</p>
                </div>
                <div class="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
                    ...
                    <div class="flex flex-col max-w-lg p-6 mx-auto text-center text-gray-900 bg-white border border-gray-100 rounded-lg shadow xl:p-8 ">
                        <h3 class="mb-1 text-2xl font-semibold">MBI</h3>
                        <p class="font-light text-gray-500 sm:text-lg ">Miescor Builders Incorporated</p>
                        <div class="flex items-baseline justify-center my-1">
                          <a href="https://www.miescor.ph/page/inner/miescor-builders_history"> <img class="card-img-top"  src="https://iam.miescor.ph/mbi.jpg" alt="Card image cap"></a> </a>
                        </div>
                        <!-- List -->
                        <ul role="list" class="mb-8 space-y-4 text-left">
                            <li class="flex items-center space-x-3">
                                <!-- Icon -->
                                <svg class="flex-shrink-0 w-5 h-5 text-green-500 " fill="currentColor" ><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg>
                            ...
                            <li class="flex items-center space-x-3">
                                ...
                                <span>2019 Award of Excellence from Safety Organization of the Philippines, Inc. (SOPI) f</span>
                            </li>
                            <li class="flex items-center space-x-3">
                                <!-- Icon -->
                                <svg class="flex-shrink-0 w-5 h-5 text-green-500 " fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg>
                                <span>2018 Safety Award of Merit</span>
                            </li>
                            <li class="flex items-center space-x-3">
                                <!-- Icon -->
                                <svg class="flex-shrink-0 w-5 h-5 text-green-500 " fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg>
                                <span>2018 Best Safety Program</span>
                            </li>
                            <li class="flex items-center space-x-3">
                                <!-- Icon -->
                                <svg class="flex-shrink-0 w-5 h-5 text-green-500 " fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg>
                                <span>2018 SOPI’s Award of Excellence </span>
                            </li>
                            <li class="flex items-center space-x-3">
                                <!-- Icon -->
                                <svg class="flex-shrink-0 w-5 h-5 text-green-500 " fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg>
                                <span>2017 SOPI’s Award of Distinction</span>
                            </li>
                        </ul>
                    ...
                    <!-- Pricing Card -->
                    <div class="flex flex-col max-w-lg p-6 mx-auto text-center text-gray-900 bg-white border border-gray-100 rounded-lg shadow xl:p-8 ">
                        <h3 class="mb-4 text-2xl font-semibold">MLI</h3>
                        <p class="font-light text-gray-500 sm:text-lg ">Miescor Logistics Incorporated</p>
                        <div class="flex items-baseline justify-center my-1">
                          <a href="https://www.miescor.ph/page/inner/miescor-logistics_history"> <img class="card-img-top"  src="https://iam.miescor.ph/mli.png" alt="Card image cap"></a> </a>
                        </div>
                        <!-- List -->
                        <ul role="list" class="mb-8 space-y-4 text-left">
                             <li class="flex items-center space-x-3">
                    ...
                    <!-- Pricing Card -->
                    <div class="flex flex-col max-w-lg p-6 mx-auto text-center text-gray-900 bg-white border border-gray-100 rounded-lg shadow xl:p-8 ">
                        <h3 class="mb-4 text-2xl font-semibold">Meralco</h3>
                        <p class="font-light text-gray-500 sm:text-lg ">Best for large scale uses and extended redistribution rights.</p>
                        <div class="flex items-baseline justify-center my-1">
                          <a href="https://www.meralco.com.ph/"> <img class="card-img-top"  src="https://iam.miescor.ph/meco.png" alt="Card image cap"></a> </a>
                        </div>
                        <!-- List -->
                        <ul role="list" class="mb-8 space-y-4 text-left">
                            <li class="flex items-center space-x-3">
  ...
  <div class="max-w-screen-xl px-4 py-8 mx-auto lg:py-16 lg:px-6 ">
      <div class="max-w-screen-sm mx-auto mb-8 text-center lg:mb-16">
          <h2 class="mb-4 text-4xl font-extrabold tracking-tight text-gray-900 ">Our Leaders</h2>
          <p class="font-light text-gray-500 lg:mb-16 sm:text-xl ">I AM MIESCOR. These three powerful words connote Integrity, Accountability, Malasakit. This is the mantra,
the guiding light that every employee of the MIESCOR Group has held sacred throughout the last 50 years in
the performance of their jobs.</p>
      </div>
      <div class="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
          <div class="items-center rounded-lg shadow bg-gray-50 sm:flex ">
              <a href="#">
                  <img class="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" src="https://iam.miescor.ph/mvp.png" alt="Bonnie Avatar">
              </a>
              <div class="p-5">
                  <h3 class="text-xl font-bold tracking-tight text-gray-900 ">
                      <a href="#">MANUEL V. PANGILINAN</a>
                  </h3>
                  <span class="text-orange-600 ">Chairman and CEO</span><br><span class="text-gray-500 ">Meralco</span>
                  <p class="mt-3 mb-4 font-light text-gray-500 ">It is with great pleasure and pride that I join the exceptional men and women of MIESCOR in the
celebration of its Golden Jubilee. </p>
                  <ul class="flex space-x-4 sm:mt-0">
                      <li>
                          <a href="#" class="text-orange-600 hover:text-gray-900 ">
          ...
          <div class="items-center rounded-lg shadow bg-gray-50 sm:flex ">
              <a href="#">
                  <img class="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" src="https://iam.miescor.ph/rola.png" alt="Jese Avatar">
              </a>
              <div class="p-5">
                  <h3 class="text-xl font-bold tracking-tight text-gray-900 ">
                      <a href="#">RONNIE L. APEROCHO</a>
                  </h3>
                  <span class="text-orange-600 ">Chief Operating Officer, Meralco</span><br><span class="text-gray-500 ">Former President and CEO, MIESCOR</span>
                  <p class="mt-3 mb-4 font-light text-gray-500 ">We commemorate MIESCOR’s significant milestone by reflecting on the company’s extraordinary
journey spanning five decades.</p>
                  <ul class="flex space-x-4 sm:mt-0">
                      <li>
                          <a href="#" class="text-orange-600 hover:text-gray-900 ">
                              <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path fill-rule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clip-rule="evenodd" /></svg>
          ...
          <div class="items-center rounded-lg shadow bg-gray-50 sm:flex ">
              <a href="#">
                  <img class="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" src="https://iam.miescor.ph/ferd.png" alt="Michael Avatar">
              </a>
              <div class="p-5">
                  <h3 class="text-xl font-bold tracking-tight text-gray-900 ">
                      <a href="#">FERDINAND O. GELUZ</a>
                  </h3>
                  <span class="text-orange-600 ">Chairman</span><br><span class="text-gray-500 ">MIESCOR</span>
                  <p class="mt-3 mb-4 font-light text-gray-500 ">It is with pride and joy that I extend my heartfelt congratulations to the entire MIESCOR family on the
occasion of our milestone 50th anniversary.</p>
                  <ul class="flex space-x-4 sm:mt-0">
                      <li>
                          <a href="#" class="text-orange-600 hover:text-gray-900 ">
                              <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path fill-rule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clip-rule="evenodd" /></svg>
          ...
          <div class="items-center rounded-lg shadow bg-gray-50 sm:flex ">
              <a href="#">
                  <img class="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" src="https://iam.miescor.ph/roo.png" alt="Sofia Avatar">
              </a>
              <div class="p-5">
                  <h3 class="text-xl font-bold tracking-tight text-gray-900 ">
                      <a href="#">RICHARD O. OCHAVA</a>
                  </h3>
                  <span class="text-orange-600 ">President and CEO</span><br><span class="text-gray-500 ">MIESCOR</span>
                  <p class="mt-3 mb-4 font-light text-gray-500 ">Embracing my new role as President, I am humbled by the privilege to lead an exceptional team as we celebrate
our golden jubilee.</p>
                  <ul class="flex space-x-4 sm:mt-0">
                      <li>
                          <a href="#" class="text-orange-600 hover:text-gray-900 ">
                              <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path fill-rule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clip-rule="evenodd" /></svg>
...
<section class="bg-white ">
    <div class="max-w-screen-xl px-4 py-8 mx-auto lg:py-16">
        <h2 class="mb-8 text-3xl font-extrabold leading-tight tracking-tight text-center text-gray-900 lg:mb-16 md:text-4xl">You’ll be in good company</h2>
        <div class="grid grid-cols-2 gap-8 text-gray-500 sm:gap-12 md:grid-cols-3 lg:grid-cols-6 ">
            ...
            <a href="#" class="flex items-center justify-center">
                <svg class="h-9 hover:text-gray-900 " viewBox="0 0 137 37" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="#" class="flex items-center justify-center">
                <svg class="h-6 hover:text-gray-900 " viewBox="0 0 124 21" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
<!-- footer -->
<footer class="bg-black" style="width: 100%;">
    <div class="w-full mx-auto max-w-screen-2xl">

    <div class="px-4 py-6 bg-black md:flex md:items-center md:justify-between">
        <span class="text-sm text-gray-500 sm:text-center">All Rights Reserved © 2024 <a href="https://www.miescor.ph/"><span style="color: #f85815;">MIESCOR powered by Meralco</span></a>.
        </span>
